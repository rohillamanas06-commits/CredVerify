...
export function Footer() {
  return (
    <footer className="bg-black text-white/70 border-t border-white/10 pt-8 pb-8">
      <div className="w-full px-4 md:px-8 mx-auto flex flex-col md:flex-row justify-between gap-12">
        <div className="max-w-xs">
          ...
          <div className="flex gap-4">
            <a href="https://github.com/rohillamanas06-commits" target="_blank" rel="noreferrer" className="text-white/60 hover:text-white transition">
